...
const orders = [
    { id: 1, image: "images/p-3.jpg", destination: "Mumbai", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
    { id: 2, image: "images/p-4.jpg", destination: "Nagpur", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
    { id: 3, image: "images/p-5.jpg", destination: "mumbai", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
    { id: 4, image: "images/p-6.jpg", destination: "Shimla", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
    { id: 5, image: "images/p-3.jpg", destination: "mumbai", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
    { id: 6, image: "images/p-4.jpg", destination: "Shimla", price: '$90.00', description: "Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Veritatis, Nam!" },
];
...
for (const order of orders) {
    ...
    orderElement.innerHTML = ` <div class="box">
        ...
        <div class="content">
            ...
            <div class="price">${order.price} <span>$120.00</span> </div>
                <button href="#" class="btn" id="bookbutton" onClick="redirectBook(${order.id})"             
                >book now</button> 
            </div>
        </div>
